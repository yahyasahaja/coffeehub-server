...
// Name our cache
var CACHE_NAME = 'CoffeeHub_Custom_3';
...
importScripts('/my-project-service-worker.js')
...
var hashedHTMLLocation = urlsToCacheKeys.get(htmlLocation)
...
function fetchData(event) {
  ...
  for (let i in routers) if (path.indexOf(routers[i]) === 0 ) {
    ...
    return caches.match(hashedHTMLLocation)
  }
